 ...
 */
#define RTPRIV_IOCTL_FLAG_UI		0x0001	/* Notify this private cmd send by UI. */
...
/* TODO: Consider upgrading the zero-length arrays to use empty brackets
 * since the `[]` notation was standardized in C99
 */
struct bbp_info {
	UINT32 bbp_start;
	UINT32 bbp_end;
